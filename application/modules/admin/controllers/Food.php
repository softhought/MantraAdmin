...
public function index(){ 
    ...
    {   
        ...
        $orderby='videotitle'; 
        $data['rowFoodMaster'] = $this->_dietmodel->GetAllFoodMaster();
        // pre($data['otherAssistanceList']);exit;
        $data['view_file'] = 'dashboard/diet/masters/food/food_view';       
    ...
    {  
       ...
       if($this->uri->segment(4) == NULL){
        ...
        $data['foodEditdata'] = [];
          ...
          $data['foodId'] = $this->uri->segment(4);
          $where = array('id'=>$data['foodId']);
          $data['foodEditdata'] = $this->commondatamodel->getSingleRowByWhereCls('diet_food_master',$where);

       }
      // exit;
       
        $orderby='food_type_name'; 
        $data['rowFoodType'] = $this->commondatamodel->getAllRecordWhereOrderBy('food_type',[],$orderby);

        $orderby='food_type_name'; 
        $data['rowFoodUnit'] = $this->commondatamodel->getAllRecordWhereOrderBy('diet_unit_master',[],$orderby);

        $orderby='category'; 
        $data['rowFoodCategory'] = $this->commondatamodel->getAllRecordWhereOrderBy('diet_food_category',[],$orderby);

        $data['view_file'] = 'dashboard/diet/masters/food/addedit_food';  
        $header="";
        $this->template->admin_template($data);  
