...
<section class="layout-box-content-format1">
        ...
        <div class="card card-primary">
            ...
            <div class="card-header box-shdw">
              ...
              <h3 class="card-title">After Exchanging Package, previous package will be inactive</h3>
            ...
            <div class="card-body">
               ...
               <input type="hidden" name="pre_branch_id" id="pre_branch_id" value="">
                ...
                <div class="formblock-box">   
                   <h3 class="form-block-subtitle"><i class="fas fa-angle-double-right"></i>Exchange Package - Registration (GST)</h3> 
                ...
                <div class="formblock-box">   
                 ...
                 <div class="formblock-box">   
                   <h3 class="form-block-subtitle"><i class="fas fa-angle-double-right"></i>Admission & Payment Information(s) - Exchange Package</h3> 
                            <div class="row">
