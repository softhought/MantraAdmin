...
<section class="layout-box-content-format1">
        <div class="card card-primary">
            <div class="card-header box-shdw">
              <h3 class="card-title">Confirmation - Product Sale (GST)</h3>
                ...
                <div class="formblock-box">  
                  <?php
                    ...
                    <div class="col-md-3"></div>    
                      ...
                      <div class="row"> 
                    <div class="col-md-3"></div>    
                           <label class="col-md-2 labletext" for="enquiry_dt">Product</label>                         
                                <div class="col-md-3">   
                                        <div class="form-group">
                                        <div class="input-group input-group-sm">                                                             
                                            <input type="text" class="form-control forminputs typeahead" id="first_name" name="first_name"  autocomplete="off" value="<?php echo $PROD_DESC;?>" readonly>
                                        </div>
                                    </div>
                                </div> 
                      </div>
                      <div class="row"> 
                    <div class="col-md-3"></div>    
                           <label class="col-md-2 labletext" for="enquiry_dt">Guest</label>                         
                                <div class="col-md-3">   
                                        <div class="form-group">
                                        <div class="input-group input-group-sm">                                                             
                                            <input type="text" class="form-control forminputs typeahead" id="first_name" name="first_name"  autocomplete="off" value="<?php echo $guest;?>" readonly>
                                        </div>
                                    </div>
                                </div> 
                      </div>
