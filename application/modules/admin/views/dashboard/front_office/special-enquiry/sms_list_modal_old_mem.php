...
<table align="center" cellspacing="0" cellpadding="0" border="0" class="table table-striped table-hover" style="width:99%;margin:0 auto;font-size:15px;border: 2px solid #DDD;margin-bottom:20px;">
    ...
    <?php 
    $k=1;
    foreach($oldmemsmsdel as $oldmemsmsdel){?>
    <tr class="content">
        <td class="content_txt" align="right" width="2%"><?php echo $k++;?></td>
        <td class="content_txt" align="left"><?php echo date('d-m-Y',strtotime($oldmemsmsdel->date_of_sending)); ?></td>
        <td class="content_txt" align="left"><?php echo $oldmemsmsdel->sms_title; ?></td>
        <td class="content_txt" align="left"><?php echo $oldmemsmsdel->sms_matter; ?></td>
