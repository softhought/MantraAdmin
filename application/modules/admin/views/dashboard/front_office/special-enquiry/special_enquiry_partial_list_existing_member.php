...
<table  class="table customTbl table-bordered table-hover  tablepad" id="specialEnqTable">
	...
	<tr>                     
                  ...
                  <input type="checkbox" class="call-checkbox rowCheck" name="id[]" id="row_check_<?php echo $row; ?>" value="<?php echo $specialenquirylist->CUS_ID; ?>">
                            ...
                            <td>  <br><a href="javascript:void(0);" data-toggle="modal" data-id="<?php echo $specialenquirylist->CUS_ID; ?>" data-target="#smslistmodel" class="smsListExtmem hidebtn_<?php echo $specialenquirylist->CUS_ID; ?>">
                            <img src="<?php echo base_url(); ?>assets/img/sms.png" width="30" height="30" /></a>
                            <a href="javascript:void(0);" data-toggle="modal" data-id="<?php echo $specialenquirylist->CUS_ID; ?>" data-target="#emaillistmodel" class="emailListExistingmem hidebtn_<?php echo $specialenquirylist->CUS_ID; ?>">
