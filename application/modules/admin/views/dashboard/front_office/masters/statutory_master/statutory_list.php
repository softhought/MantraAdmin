...
<div class="card card-primary">
    <div class="card-header box-shdw">
      <h3 class="card-title">Statutory List</h3>
       <div class="btn-group btn-group-sm float-right" role="group" aria-label="MoreActionButtons" >
      <a href="<?php echo admin_with_base_url(); ?>statutorymaster/addeditstatutory" class="btn btn-default btnpos">
       ...
       <div id="">
        <table class="table customTbl table-bordered table-hover dataTable tablepad">
          ...
          foreach ($statutorylist as $statutorylist) { ?>
            <tr>
            <td><?php echo $i++; ?></td>
            <td><?php echo $statutorylist->statutory_name; ?></td>                    
            ...
            <td align="center">
              <a href="<?php echo admin_with_base_url(); ?>statutorymaster/addeditstatutory/<?php echo $statutorylist->id; ?>" class="btn tbl-action-btn padbtn">
