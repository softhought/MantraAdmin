<script src="<?php echo base_url();?>assets/js/customJs/front_office/onedayfreeguestpass.js"></script>
<section class="layout-box-content-format1">

<div class="card card-primary">
    <div class="card-header box-shdw">
      <h3 class="card-title">One day free guest pass  </h3>
