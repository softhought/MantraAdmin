<script src="<?php echo base_url();?>assets/js/customJs/front_office/enquiry_analysis.js"></script>
<section class="layout-box-content-format1">

<div class="card card-primary">
    <div class="card-header box-shdw">
      <h3 class="card-title">Enquiry Analysis</h3>
    ...
    <div class="list-search-block">
               ...
               <div class="col-sm-3">
                      ...
                      <div class="form-group">
                       <div class="input-group input-group-sm">
                        ...
                        <select class="form-control select2" name="search_by" id="search_by">
                              ...
                              <?php
                                   foreach (json_decode(SEARCH_BY2) as $key=>$value){  ?>
                ...
                <label for="payment">&nbsp;</label>
                 <button type="button" class="btn btn-block action-button btn-sm" id="analysisviewbtn" style="width: 60%;">Show</button>
