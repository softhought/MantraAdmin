                        ...
                        <div class="row bhoechie-tab-container">
                                ...
                                <div id="myjstree" class="col-sm-6"> 
                                    ...
                                    <ul> 
                                               ...
                                               <?php if(sizeof($Menulist)>0)  {

                                                    foreach($Menulist as $firstlevel) { 

                                                        if(sizeof($firstlevel['secondLevelMenu'])>0) {  ?>

                                                            <li id="<?php echo $firstlevel['FirstLevelMenuData']->id;?>"><?php echo $firstlevel['FirstLevelMenuData']->menu_name;?>  
                                                                ...
                                                                <?php foreach($firstlevel['secondLevelMenu'] as $second_lvl)    {     
                                                                        ...
                                                                        if(sizeof($second_lvl['thirdLevelMenu'])>0){ ?>
                                                                            ...
                                                                            <li id="<?php echo $second_lvl['secondLevelMenuData']->id; ?>"><?php echo $second_lvl['secondLevelMenuData']->menu_name; ?>
                                                                           ...
                                                                           <?php }else{ ?>
                                                                            ...
                                                                            <li id="<?php echo $second_lvl['secondLevelMenuData']->id;?>"><?php echo $second_lvl['secondLevelMenuData']->menu_name;?></li>
                                                            ...
                                                            <li id="<?php echo $firstlevel['FirstLevelMenuData']->id; ?>"><?php echo$firstlevel['FirstLevelMenuData']->menu_name; ?></li>
