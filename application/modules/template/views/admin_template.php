...
<head>
  ...
  <title>Mantra The Life Style Health Club</title>
...
<body class="hold-transition layout-top-nav" style="margin:0;">
              ...
              <li>
                ...
                ?> </a>
                  ...
                  <li>
                    ...
                    <h6 id="ac_year_title"> <?php echo $acc_period;?></h6> 
      ...
      <div class="collapse navbar-collapse order-3" id="navbarCollapse">
        ...
        <ul class="navbar-nav">
          ...
          <li class="nav-item dropdown">
            ...
            <ul aria-labelledby="dropdownSubMenu1" class="dropdown-menu border-0 shadow">              
              ...
              <?php 
                ...
                if(sizeof($second_lvl['secondLevelMenu'])>0){	
              ...
              <li class="dropdown-submenu dropdown-hover">
                ...
                <ul aria-labelledby="dropdownSubMenu2" class="dropdown-menu border-0 shadow">                  
                  ...
                  <?php foreach($second_lvl['secondLevelMenu'] as $third_lvl){

                    if(sizeof($third_lvl['secondLevelMenu'])>0){	
                    ?>

                  <li class="dropdown-submenu">

                    <a id="dropdownSubMenu3" href="<?php echo admin_with_base_url().$third_lvl['second_menu_link']; ?>"  role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="dropdown-item dropdown-toggle"><i class="fas fa-angle-double-right"></i> <?php echo $third_lvl['second_menu_name']; ?></a>

                    <ul aria-labelledby="dropdownSubMenu2" class="dropdown-menu border-0 shadow">                  

                      <?php foreach($third_lvl['secondLevelMenu'] as $fourth_lvl){ ?>
                        <li class="dropdown-submenu">

                    <a id="dropdownSubMenu3" href="<?php echo admin_with_base_url().$fourth_lvl['second_menu_link']; ?>"  class="dropdown-item "><i class="fas fa-angle-double-right"></i> <?php echo $fourth_lvl['second_menu_name']; ?></a>
                      </li>
                      <?php } ?>
                      </ul>
                  </li>
                  ...
                  <?php } else { ?>  
                    <li><a href="<?php echo admin_with_base_url().$third_lvl['second_menu_link']; ?>" class="dropdown-item"><i class="fas fa-caret-right"></i> <?php echo $third_lvl['second_menu_name']; ?></a></li>
                  <?php } } ?>              
                ...
                <?php }else { ?>
                  ...
                  <li><a href="<?php echo admin_with_base_url().$second_lvl['second_menu_link']; ?>" class="dropdown-item"><i class="fas fa-caret-right"></i> <?php echo $second_lvl['second_menu_name']; ?></a></li>
          ...
          <?php }else {?>
            ...
            <li class="nav-item"><a href="<?php echo admin_with_base_url().$firstlevel['menu_link'];?>" class="nav-link"><i class="fas fa-home"></i> <?php echo $firstlevel['menu_name']; ?></a></li> 
