$(document).ready(function () {
  ...
  $(document).on("click", "#dailycollectionviewbtnrev", function (event) {
    event.preventDefault();
    ...
    $("#brancherr").removeClass("form_error");

    if (branch == "") {
      $("#brancherr").addClass("form_error");
      return false;
    }
    $("#daily_collection_list").html("");
    $("#loader").css("display", "block");
    ...
    var method = "dailycollection/getAlldailycollectionreveised";
    formData = {
      from_dt: from_dt,
      to_date: to_date,
      branch: branch,
